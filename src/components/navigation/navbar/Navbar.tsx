...
const Navbar = () => {
  const avatarTargetEl = useRef<HTMLDivElement>(null)
  const avatarTriggerEl = useRef<HTMLButtonElement>(null)
  useEffect(() => {
    const avatarOptions: CollapseOptions = {
      onCollapse: () => {
        console.log('avatar element has been collapsed')
      },
      onExpand: () => {
        console.log('avatar element has been expanded')
      },
      onToggle: () => {
        console.log('avatar element has been toggled')
      },
    }
