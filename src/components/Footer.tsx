        ...
        <footer className="bg-primary">
                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0 space-y-4 flex flex-col items-start justify-between"> 
                        <a href="https://flowbite.com/" className="flex items-center">
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Simon&nbsp;| FullStack Dev</span>
                        </a>
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-secondary font-medium">
                            ...
                            <li>
                                <a href="https://medium.com/@simomor" className="hover:underline" target='_blank' rel='noreferrer'>Medium</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-secondary font-medium">
                            <li className="mb-4">
                                <a href="https://github.com/MagusM" className="hover:underline" target='_blank' rel='noreferrer'>Github</a>
                            </li>
                            <li>
                                <a href="cssbattle.dev/player/simonmor" className="hover:underline" target='_blank' rel='noreferrer'>css-battle</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
                    ...
                    <span className='text-red-400'>Simon Mor</span> All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://github.com/MagusM" target='_blank' rel='noreferrer' className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
