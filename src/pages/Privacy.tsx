const Privacy = () => {
    return (
        <div>
            Privacy Policy for Simon Mor's Portfolio Website At Simon Mor's
            Portfolio Website, accessible from [insert website URL], one of our
            main priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Simon Mor's Portfolio Website and how we use it. If you
            ...
            [insert contact email address]. Log Files Simon Mor's Portfolio
            ...
            information. Cookies and Web Beacons Like any other website, Simon
            Mor's Portfolio Website uses 'cookies'. These cookies are used to
            ...
            Policy for each of the advertising partners of Simon Mor's Portfolio
            Website. Third-party ad servers or ad networks uses technologies
            like cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Simon Mor's
            Portfolio Website, which are sent directly to users' browser. They
            automatically receive your IP address when this occurs. These
            technologies are used to measure the effectiveness of their
            advertising campaigns and/or to personalize the advertising content
            that you see on websites that you visit. Note that Simon Mor's
            Portfolio Website has no access to or control over these cookies
            that are used by third-party advertisers. Third Party Privacy
            Policies Simon Mor's Portfolio Website's Privacy Policy does not
            ...
            respective websites. Children's Information Another part of our
            ...
            and/or monitor and guide their online activity. Simon Mor's
            Portfolio Website does not knowingly collect any Personal
            ...
            our records. Online Privacy Policy Only This Privacy Policy applies
            ...
            collect in Simon Mor's Portfolio Website. This policy is not
            applicable to any information collected offline or via channels
            other than this website. Consent By using our website, you hereby
            consent to our Privacy Policy and agree to its Terms and Conditions.
        </div>
    );
};
